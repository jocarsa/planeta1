import sqlite3
import numpy as np
from tkinter import Tk, Canvas, Button, NW, Scale, HORIZONTAL
...
def update_canvas():
    global x_start, y_start, section_size, canvas, tk_img, cur, height_multiplier
...
slider = Scale(root, from_=100, to=2000, orient=HORIZONTAL, label="Height Multiplier", command=update_height_multiplier)
slider.set(height_multiplier)
slider.pack()
