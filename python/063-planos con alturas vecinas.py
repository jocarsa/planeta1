        ...
        for y in range(y_start, y_end):
            ...
            for nx, ny in neighbors:
                if (nx, ny) in terrain_dict:
                    ...
                    n_normalized_value = 0.0  # Default height if no neighbor
...
slider_y_pixel_offset = Scale(root, from_=-section_size//2-200, to=section_size//2+2500, orient=HORIZONTAL, label="Y Pixel Offset", command=update_y_pixel_offset)
