...
label_height_multiplier = ttk.Label(root, text="Multiplicador de altura")
...
label_y_pixel_offset = ttk.Label(root, text="Desfase del terreno")
...
label_pixel_separation = ttk.Label(root, text="Separación de pixeles")
...
label_cloud_offset = ttk.Label(root, text="Separación de las nubes")
label_cloud_offset.grid(row=8, column=1, padx=10, pady=(10, 0))
slider_cloud_offset = ttk.Scale(root, from_=5, to=500, orient=HORIZONTAL, command=update_cloud_offset)
...
label_shadow_factor = ttk.Label(root, text="Factor de sombra")
