...
# Function to draw a 3D sphere on the left canvas
def draw_sphere():
    ...
    for i in range(num_parallels):
        ...
        for j in range(num_meridians):
            ...
            x1, y1 = get_screen_coordinates(lat1_rot, lon1_rot)
            x2, y2 = get_screen_coordinates(lat2_rot, lon2_rot)
            x3, y3 = get_screen_coordinates(lat3_rot, lon3_rot)
            x4, y4 = get_screen_coordinates(lat4_rot, lon4_rot)
