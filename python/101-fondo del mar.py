        ...
        for y in range(y_start, y_end):
            ...
            if normalized_value < water_level:
                ...
                if len(neighbor_iso) == 3:
                    ...
                    # Apply semi-transparent water color overlay
                    draw_water.polygon(water_points, fill=(color[0], color[1], color[2], 128))  # Maintain original terrain color, with added transparency
...
label_y_pixel_offset.grid(row=0, column=1, padx=5)
...
slider_shadow_factor.grid(row=1, column=4, padx=5)
...
label_cloud_transparency.grid(row=0, column=5, padx=5)
...
slider_cloud_transparency.grid(row=1, column=5, padx=5)
...
label_cloud_brightness_offset.grid(row=0, column=6, padx=5)
...
slider_cloud_brightness_offset.grid(row=1, column=6, padx=5)
