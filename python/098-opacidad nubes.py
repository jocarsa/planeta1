...
def update_canvas():
    global x_start, y_start, section_size, canvas, tk_img, cur, height_multiplier, y_pixel_offset, pixel_separation, cloud_offset, shadow_factor, cloud_transparency, cloud_brightness_offset
...
# Create a frame to hold the sliders horizontally
slider_frame = ttk.Frame(root)
slider_frame.grid(row=2, column=0, columnspan=3, padx=10, pady=10, sticky="ew")

# Create a slider to adjust the height multiplier
label_height_multiplier = ttk.Label(slider_frame, text="Multiplicador de altura")
label_height_multiplier.grid(row=0, column=0, padx=10, pady=(10, 0))
slider_height_multiplier = ttk.Scale(slider_frame, from_=100, to=2000, orient=HORIZONTAL, command=update_height_multiplier)
slider_height_multiplier.set(height_multiplier)
slider_height_multiplier.grid(row=1, column=0, padx=10, pady=5)

# Create a slider to adjust the y pixel offset
label_y_pixel_offset = ttk.Label(slider_frame, text="Desfase del terreno")
label_y_pixel_offset.grid(row=0, column=1, padx=10, pady=(10, 0))
slider_y_pixel_offset = ttk.Scale(slider_frame, from_=-section_size//2-200, to=section_size//2+5500, orient=HORIZONTAL, command=update_y_pixel_offset)
slider_y_pixel_offset.set(y_pixel_offset)
slider_y_pixel_offset.grid(row=1, column=1, padx=10, pady=5)

# Create a slider to adjust the pixel separation
label_pixel_separation = ttk.Label(slider_frame, text="Separación de pixeles")
label_pixel_separation.grid(row=0, column=2, padx=10, pady=(10, 0))
slider_pixel_separation = ttk.Scale(slider_frame, from_=1, to=10, orient=HORIZONTAL, command=update_pixel_separation)
slider_pixel_separation.set(pixel_separation)
slider_pixel_separation.grid(row=1, column=2, padx=10, pady=5)

# Create a slider to adjust the cloud offset
label_cloud_offset = ttk.Label(slider_frame, text="Separación de las nubes")
label_cloud_offset.grid(row=0, column=3, padx=10, pady=(10, 0))
slider_cloud_offset = ttk.Scale(slider_frame, from_=5, to=500, orient=HORIZONTAL, command=update_cloud_offset)
slider_cloud_offset.set(cloud_offset)
slider_cloud_offset.grid(row=1, column=3, padx=10, pady=5)

# Create a slider to adjust the shadow factor
label_shadow_factor = ttk.Label(slider_frame, text="Factor de sombra")
label_shadow_factor.grid(row=0, column=4, padx=10, pady=(10, 0))
slider_shadow_factor = ttk.Scale(slider_frame, from_=0.0, to=1.0, orient=HORIZONTAL, command=update_shadow_factor)
slider_shadow_factor.set(shadow_factor)
slider_shadow_factor.grid(row=1, column=4, padx=10, pady=5)

# Create a slider to adjust the cloud transparency
label_cloud_transparency = ttk.Label(slider_frame, text="Transparencia de las nubes")
label_cloud_transparency.grid(row=0, column=5, padx=10, pady=(10, 0))
slider_cloud_transparency = ttk.Scale(slider_frame, from_=0.1, to=2.0, orient=HORIZONTAL, command=update_cloud_transparency)
slider_cloud_transparency.set(cloud_transparency)
slider_cloud_transparency.grid(row=1, column=5, padx=10, pady=5)

# Create a slider to adjust the cloud brightness offset
label_cloud_brightness_offset = ttk.Label(slider_frame, text="Brillo de las nubes")
label_cloud_brightness_offset.grid(row=0, column=6, padx=10, pady=(10, 0))
slider_cloud_brightness_offset = ttk.Scale(slider_frame, from_=-255, to=255, orient=HORIZONTAL, command=update_cloud_brightness_offset)
slider_cloud_brightness_offset.set(cloud_brightness_offset)
slider_cloud_brightness_offset.grid(row=1, column=6, padx=10, pady=5)
