...
def actualizar_npcs():
    ...
    # Redibujar todo el mapa equirectangular sin los crosshairs
    dibujar_mapa_equirectangular()

    # Dibujar los nuevos crosshairs de los NPCs en el mapa equirectangular
    ancho_eq, alto_eq = mapa_eq.size
    dibujar = ImageDraw.Draw(mapa_eq)
    for npc in npcs:
